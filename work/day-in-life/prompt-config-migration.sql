-- Add system prompt column to company_settings
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        AND column_name = 'day_in_life_system_prompt'
    ) THEN
        ALTER TABLE company_settings
        ADD COLUMN day_in_life_system_prompt TEXT;

        -- Set default prompt
        UPDATE company_settings
        SET day_in_life_system_prompt = 'You are a professional writer assisting residential care workers in transforming their rough notes
